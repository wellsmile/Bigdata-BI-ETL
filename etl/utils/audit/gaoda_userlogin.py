...
if __name__ == '__main__':
    ...
    imeilist= []
    with open('/mnt/disk1/tmp/caoxiaocheng/audit/imei/imei_gaoda') as imeifile:
    ...
    ordercursor.execute('select optime,role_id,type,online_time,log_id from role_login')
